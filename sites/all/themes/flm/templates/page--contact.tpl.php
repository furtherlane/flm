...
/**
 * @file
 * flm's theme implementation to display a single Drupal page.
 *
  ...
  <div id="main-wrapper" class="clearfix"><div id="main" role="main" class="clearfix">
    ...
    <div id="content" class="column"><div class="section">
      ...
      <?php endif; ?>
  	  ...
  	  <div id="contact-message">Thank you for your interest!&nbsp;&nbsp;Please contact us anytime to request a demo, provide feedback or ask questions.</div>  
